    ...
    public partial class addSeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, new DateTime(2024, 1, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "sara.mahmoud@hospital.com", true, "Dr. Sara Mahmoud", "hashed_pw_2", "01012345678", 2 },
                    { 3, new DateTime(2024, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "omar.youssef@hospital.com", true, "Dr. Omar Youssef", "hashed_pw_3", "01023456789", 2 },
                    { 4, new DateTime(2024, 2, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "nour.eldin@hospital.com", true, "Dr. Nour ElDin", "hashed_pw_4", "01034567890", 2 },
                    { 5, new DateTime(2024, 3, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "hana.fathy@hospital.com", true, "Dr. Hana Fathy", "hashed_pw_5", "01045678901", 2 },
                    { 6, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@hospital.com", true, "Admin User", "hashed_pw_6", "01056789012", 1 },
                    { 7, new DateTime(2024, 1, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "mona.kamel@hospital.com", true, "Mona Kamel", "hashed_pw_7", "01067890123", 3 },
                    { 8, new DateTime(2024, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "ahmed.hassan@hospital.com", true, "Dr. Ahmed Hassan", "hashed_pw_1", "01001234567", 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 3, 1, new TimeSpan(0, 9, 30, 0, 0), true, 5, new DateTime(2026, 6, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 9, 0, 0, 0) });

            migrationBuilder.InsertData(
                table: "TimeSlots",
                columns: new[] { "Id", "BookedCount", "DoctorId", "EndTime", "MaxCapacity", "SlotDate", "StartTime" },
                values: new object[] { 2, 5, 1, new TimeSpan(0, 10, 30, 0, 0), 5, new DateTime(2026, 6, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 10, 0, 0, 0) });

            migrationBuilder.InsertData(
                table: "TimeSlots",
                columns: new[] { "Id", "BookedCount", "DoctorId", "EndTime", "IsAvailable", "MaxCapacity", "SlotDate", "StartTime" },
                values: new object[] { 3, 2, 2, new TimeSpan(0, 9, 30, 0, 0), true, 4, new DateTime(2026, 6, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 9, 0, 0, 0) });

            migrationBuilder.InsertData(
                table: "TimeSlots",
                columns: new[] { "Id", "BookedCount", "DoctorId", "EndTime", "MaxCapacity", "SlotDate", "StartTime" },
                values: new object[] { 4, 4, 2, new TimeSpan(0, 11, 30, 0, 0), 4, new DateTime(2026, 6, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 11, 0, 0, 0) });

            migrationBuilder.InsertData(
                table: "TimeSlots",
                columns: new[] { "Id", "BookedCount", "DoctorId", "EndTime", "IsAvailable", "MaxCapacity", "SlotDate", "StartTime" },
                values: new object[] { 5, 1, 3, new TimeSpan(0, 8, 30, 0, 0), true, 3, new DateTime(2026, 6, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 8, 0, 0, 0) });

            migrationBuilder.InsertData(
                table: "TimeSlots",
                columns: new[] { "Id", "DoctorId", "EndTime", "IsAvailable", "MaxCapacity", "SlotDate", "StartTime" },
                values: new object[] { 6, 3, new TimeSpan(0, 14, 30, 0, 0), true, 3, new DateTime(2026, 6, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 14, 0, 0, 0) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 7, 3, 4, new TimeSpan(0, 10, 30, 0, 0), true, 6, new DateTime(2026, 6, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 10, 0, 0, 0) },
                    { 8, 2, 5, new TimeSpan(0, 13, 30, 0, 0), true, 5, new DateTime(2026, 6, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 13, 0, 0, 0) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 1, 1.0, null, 1, "Completed", 1 },
                    { 3, 2, 2, 2.0, null, 2, "Completed", 3 },
                    { 5, 3, 3, 1.5, null, 1, "Cancelled", 5 },
                    { 7, 4, 4, 1.0, null, 3, "Completed", 7 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 5, new DateTime(2025, 6, 12, 9, 50, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 6, 12, 10, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 6, 12, 10, 28, 0, 0, DateTimeKind.Unspecified), "Present" },
                    ...
                    { 4, 7, new DateTime(2025, 6, 10, 11, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 6, 10, 11, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 6, 10, 11, 0, 0, 0, DateTimeKind.Unspecified), "Absent" }
                });
        }
